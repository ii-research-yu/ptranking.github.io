...
class IRFGAN_List(AdversarialMachine):
    def __init__(self, eval_dict, data_dict, sf_para_dict=None, f_div_id='KL', temperature=None, d_epoches=1, g_epoches=1, samples_per_query=5, top_k=5,
...
###### Parameter of IRFGAN_List ######

class IRFGAN_ListParameter(ModelParameter):
    ''' Parameter class for List_IR_GAN '''
    def __init__(self, debug=False, para_json=None):
        super(IRFGAN_ListParameter, self).__init__(model_id='IRFGAN_List')
        self.debug = debug
        self.para_json = para_json

    def default_para_dict(self):
        """
        Default parameter setting for IRFGAN_List
        :return:
        """
        temperature = 0.2
        ...
        ad_para_dict = dict(model_id=self.model_id, d_epoches=d_epoches, g_epoches=g_epoches, f_div_id=f_div_id,
    ...
    def grid_search(self):
        """
        Iterator of parameter settings for IRFGAN_List
        """
        ...
        for d_g_epoches, samples_per_query, ad_training_order, temperature, f_div_id in product(choice_d_g_epoch,
                                            choice_samples_per_query, choice_ad_training_order,
                                            choice_temperature, choice_f_div_id):
            d_epoches, g_epoches = d_g_epoches
            self.ad_para_dict = dict(model_id=self.model_id, d_epoches=d_epoches, g_epoches=g_epoches,
                                     samples_per_query=samples_per_query, temperature=temperature, f_div_id=f_div_id,
